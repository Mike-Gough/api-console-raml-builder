...
export declare class ASTNodeImpl extends BasicASTNode implements hl.IEditableHighLevelNode {
    ...
    private getExtractedLowLevelChildren(n);
    ...
    private mergeLowLevelChildren(originalChildren, masterChildren);
    private mergeLowLevelChild(result, originalChild, masterChild);
